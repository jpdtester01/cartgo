...
class HomeController extends Controller
{
	public function index(Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('template.section',['prodData'=>$getData, 'userData'=>$userData, 'historyData'=>$historyData, 'imgData'=>$imgData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'WishData'=>$WishData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'site'=>'index']);
			...
			return view('template.section',['prodData'=>$getData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'imgData'=>$imgData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'site'=>'index']);
    ...
    public function ComingSoon(Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('template.section',['prodData'=>$getData, 'userData'=>$userData, 'historyData'=>$historyData, 'imgData'=>$imgData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'WishData'=>$WishData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'site'=>'ComingSoon']);
			...
			return view('template.section',['prodData'=>$getData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'imgData'=>$imgData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'site'=>'ComingSoon']);
