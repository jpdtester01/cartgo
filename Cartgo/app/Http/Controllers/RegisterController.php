...
class RegisterController extends Controller
{
	public function Index(Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('template.section',['prodData'=>$getData, 'userData'=>$userData, 'historyData'=>$historyData, 'imgData'=>$imgData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData,'WishData'=>$WishData,'site'=>'register']);
			...
			return view('template.section',['prodData'=>$getData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'imgData'=>$imgData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'site'=>'register']);
